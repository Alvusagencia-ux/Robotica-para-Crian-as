...
export default function Page() {
  return (
    <main className="bg-[#F6F1E7] min-h-screen mx-auto max-w-2xl px-6 py-16 text-[#17342F]">
      <h1 className="text-3xl font-bold text-[#17342F]">Política de Privacidad</h1>
      <p className="mt-2 text-sm text-[#405650]">Última actualización: {LAST_UPDATED}</p>

      <h2 className="mt-8 text-xl font-semibold text-[#17342F]">1. Qué datos recopilamos</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-xl font-semibold text-[#17342F]">2. Cookies</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-xl font-semibold text-[#17342F]">3. Terceros</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-xl font-semibold text-[#17342F]">4. Contacto</h2>
