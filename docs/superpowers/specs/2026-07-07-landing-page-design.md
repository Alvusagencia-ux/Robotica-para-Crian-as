...
- **[Ação do usuário]** Verificar no painel Hotmart quais métodos de pagamento estão ativos por país (AR/CL/PE/CO/EC/MX) e finalizar copy da FAQ (3) com base nos resultados reais — não posso verificar isso, só quem tem acesso à conta Hotmart
